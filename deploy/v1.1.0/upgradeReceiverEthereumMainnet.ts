...
const upgradeReceiverEthereumMainnet = async (hardhat: HardhatRuntimeEnvironment) => {
  // @ts-ignore
  ...
  console.log(`Transactions Generated: deploy/v1.1.0/populatedTransactions.receiver.${hardhat.network}.json`)
}

export default upgradeReceiverEthereumMainnet;