...
import saveUpgradePopulatedTransactions from "../../files/saveUpgradePopulatedTransactions"
...
export async function configureBeaconDeployment(ethers: any) {
  ...
  saveUpgradePopulatedTransactions(populatedTransactions, `${__dirname}/populatedTransactions.json`)
}
